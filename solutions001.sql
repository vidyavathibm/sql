...
select h.hotel_no,h.name,h.city,r.room_no,r.rtype,r.price,
g.guest_no,b.date_from,b.date_to,g.name,g.city from hotel h 
left join room r on h.hotel_no=r.hotel_no
left join booking b on h.hotel_no=b.hotel_no and r.room_no=b.room_no
...
left join room r on h.hotel_no=r.hotel_no
left join booking b on h.hotel_no=b.hotel_no and r.room_no=b.room_no
left join guest g on b.guest_no=g.guest_no where h.city="New York";
...
select h.name as Hotel_name,b.room_no,b.Date_From as "Booking dates" from booking b 
inner join hotel h on b.hotel_No=h.hotel_No where h.city="New York";
